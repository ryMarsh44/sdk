...
impl ProofRequestBuilder {
    fn v1() -> ProofRequestBuilder_v1 {

    }
}
pub struct ProofRequestBuilder_v1 {
...
pub trait MsgUtils {
    ...
    fn wrap_err(&self, err: u32) -> Option<Result<T, u32>> { Some(Err(err))}
}
    ...
    pub fn build(self) -> Result<ProofRequestMessage, u32> {
        Ok(ProofRequestMessage {
            ...
            proof_request_data: ProofRequestData {
                nonce: self.mandatory_field(self.requested_attributes.clone())?,
...
mod tests {
    ...
    fn test_proof_request_msg() {
        ...
        let mut request = ProofRequestBuilder::new()

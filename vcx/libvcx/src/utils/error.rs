...
pub static MISSING_MSG_FIELD: Error = Error{ code_num: 1087, message: "Mandatory message field missing"};
pub static INVALID_PROOF_REQ: Error = Error{ code_num: 1088, message: "Proof Request is invalid"};
...
lazy_static! {
    static ref ERROR_C_MESSAGES: HashMap<u32, CString> = {
       let mut m = HashMap::new();
        ...
        insert_c_message(&mut m, &MISSING_MSG_FIELD);
        insert_c_message(&mut m, &INVALID_PROOF_REQ);

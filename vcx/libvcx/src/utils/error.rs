...
pub static MISSING_MSG_FIELD: Error = Error{ code_num: 1086, message: "Mandatory message field missing"};
pub static INVALID_PROOF_REQ: Error = Error{ code_num: 1087, message: "Proof Request is invalid"};
